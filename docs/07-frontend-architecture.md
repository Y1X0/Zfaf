...
| المسار | JS (gzip) | CSS | LCP | INP | CLS |
|--------|-----------|-----|-----|-----|-----|
| `/i/[slug]` | ≤ 90KB | ≤ 25KB | ≤ 2.0s | ≤ 150ms | ≤ 0.05 |
| `/` (تسويق) | ≤ 120KB | ≤ 30KB | ≤ 2.0s | ≤ 200ms | ≤ 0.05 |
| `/dashboard` | ≤ 200KB | ≤ 40KB | ≤ 2.5s | ≤ 200ms | ≤ 0.10 |
| `/builder/[id]` | ≤ 250KB | ≤ 50KB | ≤ 2.5s | ≤ 200ms | ≤ 0.10 |

**Lighthouse CI كـ required check.** تجاوز الميزانية = بناء فاشل.
